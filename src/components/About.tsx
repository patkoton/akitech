...
const About = () => {
  return (
    <div className='bg-white from-white from-70 bg-gradient-90 to-lightCyan to-70 flex flex-col items-center md:flex-row md:space-x-4'>
      ...
      <div className='flex-col md:flex md:w-1/3 justify-center items-center text-black px-5 md:px-0 py-10 md:py-0'>
        <div className='text-center'>
            <h1 className='font-inter font-medium text-sm md:text-lg'>Aluminium . Showcase</h1>
